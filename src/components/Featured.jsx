              ...
              <div className="relative w-full h-[100vw] md:h-[30vw] xl:h-[28vw]">
                {item.img ? (
                  <div className="relative w-full h-full">
                    ...
                    {/* SIZE SELECTION */}
                    <div className="hidden bottom-0 left-0 w-full h-1/3 bg-opacity-100 bg-websecundary xl:flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-8 ">
