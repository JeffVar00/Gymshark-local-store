...
const Navbar = () => {
  ...
  return (
    <div>
      <nav
        className={`w-full z-50 flex justify-between items-center border-b-2 border-webprimary text-webprimary bg-websecundary font-bold h-14 px-4 lg:h-16 lg:px-16 fixed top-0 }`}
      >
        {/* MOBILE MENU */}
